...
class ProcessUnhcrResettlementDepartures(SilverProcessor):
    def __init__(self):
        super().__init__(origin="UNHCR", entity="resettlementdepartures", id_column_name="id_resettlementdepartures")

    def _preprocess_dataframe(self, df: DataFrame) -> DataFrame:
        return df.withColumn(
            "id_resettlementdepartures",
            concat_ws(
                "_",
