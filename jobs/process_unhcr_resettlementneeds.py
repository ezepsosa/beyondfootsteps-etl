...
class ProcessUnhcrResettlementNeeds(SilverProcessor):
    def __init__(self):
        super().__init__(origin="UNHCR", entity="resettlementneeds", id_column_name="id_resettlementneeds")

    def _preprocess_dataframe(self, df: DataFrame) -> DataFrame:
        return df.withColumn(
            "id_resettlementneeds",
            concat_ws(
                "_",
